...
import com.hsilveredu.caregiver.databinding.FragmentChecknoteBinding
    ...
    override fun onCreateView(
        ...
        (activity as MainActivity).onBackPressedDispatcher.addCallback(object: OnBackPressedCallback(true) {
            override fun handleOnBackPressed() {
                (activity as MainActivity).findNavController(R.id.nav_host_fragment_content_main).navigate(R.id.action_nav_checknote_to_nav_home)
            }
        })
